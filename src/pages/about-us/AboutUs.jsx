    ...
    <div className="about-us container section-padding">
      <div className="text">
        ...
        <p>
          ...
          n° 2019-565 du 6 juin 2019) pour la catégorie : Actions de formation.
          Toutes nos formations préparent à des certifications professionnelles
          ou blocs de compétences enregistrés dans les répertoires de la
          certification et reconnues par l'État.
        </p>
        <p>
